# FIN 798: Machine Learning and AI in Finance

A comprehensive graduate-level portfolio showcasing advanced financial data science, machine learning models, and generative AI applications built during the **FIN 798: Special Topics** course at DePaul University. 

This repository documents my progression from core financial data pipelines to training predictive machine learning models and developing autonomous, prompt-engineered AI agents for complex quantitative finance tasks.
...
* **Financial Data Engineering:** Manipulating, cleaning, and visualizing massive financial datasets using industrial Python libraries.
* **Classical Quantitative Finance:** Implementing foundational asset pricing frameworks including the Capital Asset Pricing Model (CAPM) and Fama-French Multi-Factor models.
* **Predictive Machine Learning:** Designing and evaluation of classification models (Logistic Regression, Decision Trees, Random Forests) for risk and corporate management.
* **Generative AI & Prompt Engineering:** Harnessing advanced LLMs for information extraction, sentiment scoring on earnings calls, and zero-shot/few-shot algorithmic code generation.
* **Autonomous AI Architecture:** Conceptualizing the structural architecture of functional AI Agents utilizing memory, tooling, and planning mechanisms for compliance and trading.
...
* **Generative AI & NLP:** Hugging Face Pipelines, Large Language Models (LLMs), Advanced Prompt Engineering (Chain-of-Thought, Few-Shot)
...
* **Week 2: Quantitative Data Handling & Visualization**
...
* **Week 4: Portfolio Optimization & MPT**
  * *Focus:* Modern Portfolio Theory (Markowitz Framework), identifying the Efficient Frontier, optimizing risk-return trade-offs, and calculating asset Betas.
  * *Deliverable:* Monte Carlo simulation mapping the Efficient Frontier alongside systematic CAPM expected return matrices.
* **Week 5: Multi-Factor Models & Performance Attribution**
...
* **Week 7: ML in Corporate Governance & Director Selection**
...
* **Week 9: Advanced Prompt Engineering & Code Generation**
  * *Focus:* Implementing advanced cognitive frameworks (Zero-shot, Few-shot, Chain-of-Thought prompting) for document ingestion and automated code syntax creation.
  * *Deliverable:* Prompt-engineered financial Q&A expert engine paired with secure, automated financial code generators.
* **Week 10: Autonomous AI Agent System Design**
  * *Focus:* Architectural paradigms of multi-modal AI agents combining a core LLM brain with explicit tooling, vector memory storage, and deterministic planning tracks.
  * *Deliverable:* Conceptual blueprint and design architecture of an autonomous AI Agent optimized for automated quantitative research, robo-advisory, and compliance tracking.
...
* **Components Included:**
  ...
  2. **Presentation:** Presentation materials summarizing technical strategy and performance metrics.
  3. **Final Materials:** Complete source code, notebooks, data schemas, and visualization dashboards.

---
*Note: This repository was constructed as part of my graduate studies in Finance. All code and methodologies adhere to rigorous university academic integrity and professional engineering standards.*
